                ...
                >
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-footer text-center">
                            ...
                            <button type="button" className="btn btn-danger" onClick={this.handleCloseModal}>Ya, Saya Mengerti</button>
                        </div>
