...
import { getGugusTugas, ubahGugusTugas } from '../../actions/actionGugusTugas'
        ...
        return (
            <div className="card shadow mb-4">
                <div className="card-header py-3">
                    <h6 className="m-0 font-weight-bold text-primary">Ubah Gugus Tugas</h6>
                </div>
                                    ...
                                    <div className="col-lg-7">
                                        <div className="p-5">
                                            <div className="text-center">
                                                <h1 className="h4 text-gray-900 mb-4">Data Gugus Tugas </h1>
                                            </div>
                                            ...
                                            <div  >
                                                <form onSubmit={this.props.handleSubmit(this.onSubmit)} className="user" >
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-6">
                                                            <Link to='/admin/gugustugas' className="btn btn-secondary" style={{ width: '100%' }}> Batal</Link>
...
const stateToProps = (state, myprops) => {
    ...
    return {
        initialValues: state.listGugusTugas.find(us => {
            return parseInt(us.id) === parseInt(myprops.id)
        })
    }
}

export default connect(stateToProps, { getGugusTugas, ubahGugusTugas })(formWrap)
