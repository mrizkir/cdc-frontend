...
export class GugusTugas extends Component {
    ...
    renderContent = () => {
        ...
        if (this.props.listGugusTugas.length === 0) {
            return (
                <div className="alert alert-info">Tidak ada data Gugus Tugas</div>
            )
        }
        ...
        return (
            <div className="table-responsive">
                            ...
                            return (
                                <tr key={index}>
                                    ...
                                    <td className="text-center">
                                        ...
                                        <Link className="btn btn-warning mr-2" to={`/admin/ubahgugustugas/${gugus.id}`}><i className="fas fa-edit"></i></Link>
                ...
                <KonfirmasiHapus data={this.state.dataHapus} onClickProses={this.deleteHandler} judul="Gugus Tugas" />
        ...
        return (
            <div className="card shadow mb-4">
                <div className="card-header py-3 ">
                    <h6 className="m-0 font-weight-bold text-primary">Daftar Gugus Tugas
                    <Link to="/admin/tambahgugustugas" className="btn btn-primary float-right">Tambah Gugus Tugas</Link></h6>
                </div>
...
export default connect(stateToProps, { getGugusTugas, hapusGugusTugas })(GugusTugas)
