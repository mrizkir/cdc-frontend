...
export class TambahFasilitas extends Component {
    ...
    onSubmit = async (formValues) => {
        ...
        await this.props.tambahFasilitas(formD)
        ...
        return (
            <div className="card shadow mb-4">
                <div className="card-header py-3">
                    <h6 className="m-0 font-weight-bold text-primary">Tambah Fasilitas Karantina</h6>
                </div>
                                        ...
                                        <div className="p-5">
                                            ...
                                            <div  >
                                                <form onSubmit={this.props.handleSubmit(this.onSubmit)} className="user" >
                                                    ...
                                                    <Field name="Nm_Fasilitas" component={this.renderInput} label="Nama Fasilitas" type="text" />
                                                    <Field name="alamat" component={this.renderInput} label="Alamat" type="textarea" />
...
export default connect(
    stateToProps, { tambahFasilitas, getKecamatan, getDesa })(formWrap)
