...
export class Petugas extends Component {
    ...
    renderContent = () => {
        ...
        if (this.props.listPetugas.length === 0) {
            return (
                <div className="alert alert-info">Tidak ada data Petugas</div>
            )
        }
        ...
        return (
            <div className="table-responsive">
                ...
                <KonfirmasiHapus data={this.state.dataHapus} onClickProses={this.deleteHandler} judul="Petugas" />
        ...
        return (
            <div className="card shadow mb-4">
                <div className="card-header py-3 ">
                    <h6 className="m-0 font-weight-bold text-primary">Daftar Petugas
                    <Link to="/admin/tambahpetugas" className="btn btn-primary float-right">Tambah Petugas</Link></h6>
                </div>
